...
public class TotalNutrients implements Serializable {
  /*  @JsonProperty("ENERC_KCAL")
    ...
    public TotalNutrients(ENERCKCAL eNERC_KCAL, FAT fAT, FASAT fASAT, CHOCDF cHOCDF,
                          FIBTG fIBTG, PROCNT pROCNT, CHOLE cHOLE, NA nA, CA cA, MG mG, K k,
                          FE fE, ZN zN, P p, VITARAE vITA_RAE, VITC vITC, THIA tHIA, RIBF rIBF, NIA nIA,
                          VITB6A vITB6A, FOLDFE fOLDFE, VITB12 vITB12, VITD vITD, TOCPHA tOCPHA, VITK1 vITK1) {
